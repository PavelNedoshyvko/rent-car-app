...
`;var ve={exports:{}},z={},Ae={exports:{}},ct="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",ut=ct,ft=ut;function De(){}function Fe(){}Fe.resetWarningCache=De;var dt=function(){function t(r,s,u,v,a,x){if(x!==ft){var h=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw h.name="Invariant Violation",h}}t.isRequired=t;function e(){return t}var o={array:t,bigint:t,bool:t,func:t,number:t,object:t,string:t,symbol:t,any:t,arrayOf:e,element:t,elementType:t,instanceOf:e,node:t,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e,checkPropTypes:Fe,resetWarningCache:De};return o.PropTypes=o,o};Ae.exports=dt();var je=Ae.exports,ye={exports:{}},D={},ge={exports:{}};(function(t,e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=y;/*!
...
`,Ln=({modalIsOpen:t,closeModal:e,data:o})=>{const{id:r,img:s,photoLink:u,make:v,model:a,year:x,rentalPrice:h,address:y,type:p,accessories:m,functionalities:g,fuelConsumption:_,engineSize:T,description:j,rentalConditions:L,mileage:Q}=o,K=y.split(", "),W=K[1],U=K[2],X=L.split(`
`),ie=Q.toString().replace(/^(\d)(\d+)/,"$1,$2");let Z=h.slice(1)+h[0];return i.jsxs(On,{modalIsOpen:t,closeModal:e,children:[i.jsx(_n,{children:i.jsx(Cn,{src:s||u,alt:`${v}, ${a}`})}),i.jsxs(wn,{children:[i.jsxs(En,{children:[v," ",i.jsx(Sn,{children:a}),", ",x]}),i.jsx(Mn,{children:h})]}),i.jsxs(Tn,{children:[i.jsx("li",{children:W}),i.jsx("li",{children:U}),i.jsxs("li",{children:["Id: ",r]}),i.jsxs("li",{children:["Year: ",x]}),i.jsxs("li",{children:["Type: ",p]}),i.jsxs("li",{children:["Fuel Consumption: ",_]}),i.jsxs("li",{children:["Engine Size: ",T]})]}),i.jsx(Rn,{children:j}),i.jsx(Pn,{children:"Accessories and functionalities:"}),i.jsxs(Nn,{children:[m.map((M,k)=>i.jsx("li",{children:M},k)),g.map((M,k)=>i.jsx("li",{children:M},k))]}),i.jsx(An,{children:"Rental Conditions:"}),i.jsxs(jn,{children:[X.map((M,k)=>i.jsxs("li",{children:[k===0?`${M.split(":")[0]}:`:M.split(":")[0],i.jsx("span",{children:M.split(":").slice(1).join(":")})]},k)),i.jsxs("li",{children:["Mileage: ",i.jsx("span",{children:ie})]}),i.jsxs("li",{children:["Price: ",i.jsx("span",{children:Z})]})]}),i.jsx(Dn,{href:"tel:+380730000000",children:"Rental car"}),i.jsx(Fn,{onClick:e,children:"✕"})]})},kn=b.button`
  width: ${t=>t.$width};
  height: ${t=>t.$height};
  border-radius: 12px;
  border: none;
...
`,Wn=({type:t,title:e,width:o,height:r,onClick:s})=>i.jsx(kn,{type:t,$width:o,$height:r,onClick:s,children:e}),Un="/rent-car-app/icons.svg",$n=t=>t.adverts.adverts,In=t=>t.filter,Hn=t=>t.favorites,Yn=t=>t.adverts.isLoading,Gn=Qe([$n,In],(t,e)=>{const{brand:o,price:r,mileageFrom:s,mileageTo:u}=e;return t.filter(v=>!(o&&v.make.toLowerCase()!==o.toLowerCase()||r&&parseFloat(v.rentalPrice.slice(1))!==parseFloat(r)||s&&v.mileage<parseInt(s)||u&&v.mileage>parseInt(u)))}),qn=({advert:t})=>{const e=Xe(),{id:o,img:r,photoLink:s,make:u,model:v,year:a,rentalPrice:x,address:h,rentalCompany:y,type:p,accessories:m}=t,{isModalOpen:g,openModal:_,closeModal:T}=et(),j=h.split(", "),L=j[1],Q=j[2],W=document.createElement("canvas").getContext("2d");W.font="16px Manrope";const U=`${u} ${v}`,X=W.measureText(U).width,Z=Ze(Hn).some(P=>P.id===t.id),[M,k]=ne.useState(Z);ne.useEffect(()=>{const P=localStorage.getItem("favorites");P&&e(Ce(JSON.parse(P)))},[e]);const he=()=>{k(P=>!P),e(Ce(t))};return i.jsxs("div",{children:[i.jsxs(tt,{children:[i.jsx(nt,{src:r||s,alt:`${u}, ${v}`}),i.jsx(ot,{$clicked:M,onClick:he,children:i.jsx("use",{href:Un+"#icon-heart"})})]}),i.jsxs(rt,{children:[i.jsx(at,{children:X>185?`${u}, ${a}`:i.jsxs(i.Fragment,{children:[u," ",i.jsx(st,{children:v}),", ",a]})}),i.jsx(it,{children:x})]}),i.jsxs(lt,{children:[i.jsx("span",{children:L}),i.jsx("span",{children:Q}),i.jsx("span",{children:y}),i.jsx("span",{children:p}),i.jsx("span",{children:u}),i.jsx("span",{children:o}),i.jsx("span",{children:m[2]})]}),i.jsx(Wn,{type:"button",title:"Learn more",width:"100%",height:"44px",onClick:_}),i.jsx(Ln,{data:t,modalIsOpen:g,closeModal:T})]})},Bn=b.ul`
  display: flex;
  flex-wrap: wrap;
  gap: 50px 29px;
  width: 100%;
...
`,Vn=({visibleadverts:t})=>i.jsx(Bn,{children:t.map(e=>i.jsx(zn,{children:i.jsx(qn,{advert:e})},e.id))}),Jn=b.div`
  ...
  margin-bottom: 50px;
  background-color: #3470ff;
`;export{Wn as B,Vn as G,Jn as H,Gn as a,Yn as b,In as c,Hn as d,$n as s};
