import{r as ne,u as y,e as Ye,f as Ve,g as Je,j as i,h as Qe,a as Xe,b as Ze,t as Ce}from"./index-Bfe6XS_p.js";const et=()=>{const[t,e]=ne.useState(!1);return{isModalOpen:t,openModal:()=>{e(!0)},closeModal:()=>{e(!1)}}},tt=y.div`
  position: relative;
  height: 268px;
  margin-bottom: 14px;
  border-radius: 14px;
...
`,Wn=({type:t,title:e,width:o,height:r,onClick:s})=>i.jsx(kn,{type:t,$width:o,$height:r,onClick:s,children:e}),Un="/rent-car-app/icons.svg#icon-heart",$n=t=>t.adverts.adverts,In=t=>t.filter,Hn=t=>t.favorites,Gn=Qe([$n,In],(t,e)=>{const{brand:o,price:r,mileageFrom:s,mileageTo:u}=e;return t.filter(v=>!(o&&v.make.toLowerCase()!==o.toLowerCase()||r&&parseFloat(v.rentalPrice.slice(1))!==parseFloat(r)||s&&v.mileage<parseInt(s)||u&&v.mileage>parseInt(u)))}),qn=({advert:t})=>{const e=Xe(),{id:o,img:r,photoLink:s,make:u,model:v,year:a,rentalPrice:x,address:h,rentalCompany:g,type:p,accessories:m}=t,{isModalOpen:b,openModal:_,closeModal:T}=et(),j=h.split(", "),L=j[1],Q=j[2],W=document.createElement("canvas").getContext("2d");W.font="16px Manrope";const U=`${u} ${v}`,X=W.measureText(U).width,Z=Ze(Hn).some(P=>P.id===t.id),[M,k]=ne.useState(Z);ne.useEffect(()=>{const P=localStorage.getItem("favorites");P&&e(Ce(JSON.parse(P)))},[e]);const he=()=>{k(P=>!P),e(Ce(t))};return i.jsxs("div",{children:[i.jsxs(tt,{children:[i.jsx(nt,{src:r||s,alt:`${u}, ${v}`}),i.jsx(ot,{$clicked:M,onClick:he,children:i.jsx("use",{href:Un+"#icon-heart"})})]}),i.jsxs(rt,{children:[i.jsx(at,{children:X>185?`${u}, ${a}`:i.jsxs(i.Fragment,{children:[u," ",i.jsx(st,{children:v}),", ",a]})}),i.jsx(it,{children:x})]}),i.jsxs(lt,{children:[i.jsx("span",{children:L}),i.jsx("span",{children:Q}),i.jsx("span",{children:g}),i.jsx("span",{children:p}),i.jsx("span",{children:u}),i.jsx("span",{children:o}),i.jsx("span",{children:m[2]})]}),i.jsx(Wn,{type:"button",title:"Learn more",width:"100%",height:"44px",onClick:_}),i.jsx(Ln,{data:t,modalIsOpen:b,closeModal:T})]})},Bn=y.ul`
  display: flex;
  flex-wrap: wrap;
  gap: 50px 29px;
  width: 100%;
